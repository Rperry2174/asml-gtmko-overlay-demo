...
/**
 * Back to the top of the pitch: authored lot state, lot board on screen. Safe
 * to mash mid-run — abandoning the pipeline first stops an in-flight factory
 * run from writing a fix into the lot we just restored.
 */
function resetDemo() {
  abandonFactoryRun();
  resetLot();
